...
public sealed class VendingMachineSystem : SharedVendingMachineSystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<VendingMachineEjectComponent, AfterAutoHandleStateEvent>(OnEjectHandleState);
        SubscribeLocalEvent<VendingMachineComponent, PowerChangedEvent>(OnPowerChanged);
        SubscribeLocalEvent<VendingMachineVisualsComponent, AnimationCompletedEvent>(OnAnimationCompleted);
        SubscribeLocalEvent<VendingMachineVisualsComponent, ComponentStartup>(OnVisualsStartup);
        // DS14 end
    }
