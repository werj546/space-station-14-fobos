    ...
    IComputerWindow<EmergencyConsoleBoundUserInterfaceState>
{
    ...
    public GatewayWindow()
    {
        ...
        // DS14: NextUnlockBar uses the shared DeadSpaceProgressAccent style declared in XAML.
    }
    ...
    public void UpdateState(GatewayBoundUserInterfaceState state)
    {
        ...
        foreach (var dest in _destinations)
        {
            ...
            {
                // DS14-start: preserve zero-margin row geometry while centralizing its neutral surface.
