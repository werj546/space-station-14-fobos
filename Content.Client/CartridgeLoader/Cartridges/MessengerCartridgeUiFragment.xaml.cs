...
using Robust.Client.Graphics; // DS14
...
public sealed partial class MessengerCartridgeUiFragment : BoxContainer
{
    ...
    private void RebuildUserList()
    {
        ...
        foreach (var user in filteredUsers)
        {
            ...
            if (user.UnreadCount > 0)
                button.StyleClasses.Add("DS14MenuListRowUnread");
            // DS14-end
    ...
    private static Control MakeUnreadBadge(int unreadCount)
    {
        var panel = new PanelContainer
        {
            ...
            // DS14-start: bright "new message" mark instead of a plain inset
        ...
        panel.AddChild(new Label
        {
            ...
            StyleClasses = { "DS14MenuProfileLabel" },
            FontColorOverride = Color.FromHex("#56D364"), // DS14
        });
