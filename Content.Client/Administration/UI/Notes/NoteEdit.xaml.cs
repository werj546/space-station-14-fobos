...
public sealed partial class NoteEdit : FancyWindow
{
    ...
    public NoteEdit(SharedAdminNote? note, string playerName, bool canCreate, bool canEdit)
    {
        ...
        // DS14-start
        AddDs14OptionStyles(TypeOption, SeverityOption, ExpiryLengthDropdown);
        SecretCheckBox.Label.AddStyleClass(DeadSpaceMenuSheetlet.ProfileLabel);
        PermanentCheckBox.Label.AddStyleClass(DeadSpaceMenuSheetlet.ProfileLabel);
        // DS14-end
