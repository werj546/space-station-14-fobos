...
public sealed partial class ShuttleNavControl : BaseShuttleControl
{
    ...
    protected override void Draw(DrawingHandleScreen handle)
    {
        ...
        DrawSpaceBlips(handle, worldToShuttle, shuttleToView); //DS14
    }
        ...
        Matrix3x2 shuttleToView)
    {
        ...
        {
            var screenPos = Vector2.Transform(blip.WorldPosition, worldToView);
            var pixelRadius = Math.Max(blip.Radius * MinimapScale, 3f);
            handle.DrawCircle(screenPos, pixelRadius, blip.Color);
            handle.DrawCircle(screenPos, pixelRadius, Color.Black.WithAlpha(0.45f), filled: false);
        }
    }
    // DS14-end
