...
reagent-desc-tacitic-acid = A paralytic agent that targets the larynx, rendering the user incapable of speech. Its numbing effect keeps the target unaware until they try to speak.
