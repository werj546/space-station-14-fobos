...
reagent-desc-tacitic-acid = Паралитик, воздействующий на гортань и лишающий жертву речи. Из-за онемения цель не замечает эффект, пока не попытается заговорить.
...
reagent-name-celestin = целестин
reagent-desc-celestin = Обеспечивает прилив сил, быстро выводится, не имеет ярко выраженных побочек. Результат многолетних исследований в самых секретных лабораториях Нанотрейзен.
