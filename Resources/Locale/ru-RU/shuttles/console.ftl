...
shuttle-console-nav-other-dock = Внешние стыковочные порты
shuttle-console-nav-cargo-dock = Грузовые стыковочные порты
shuttle-console-nav-arrivals-dock = Стыковочные порты прибытия
