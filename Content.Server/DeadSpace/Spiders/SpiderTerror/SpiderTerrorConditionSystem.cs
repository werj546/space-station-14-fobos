...
public sealed partial class SpiderTerrorConditionSystem : EntitySystem
{
    ...
    {
        SubscribeLocalEvent<SpiderTerrorConditionComponent, ObjectiveGetProgressEvent>(OnGetProgress);
    }

    private void OnGetProgress(EntityUid uid, SpiderTerrorConditionComponent component, ref ObjectiveGetProgressEvent args)
    {
