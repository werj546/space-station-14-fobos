...
public sealed partial class ChangelingObjectiveSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<ChangelingGainedOrUpdatedIdentityEvent>(OnChangelingGainedOrUpdatedIdentity);
        SubscribeLocalEvent<ChangelingUniqueIdentityConditionComponent, ObjectiveGetProgressEvent>(OnGetUniqueIdentitiesProgress);
        SubscribeLocalEvent<ChangelingMostIdentitiesConditionComponent, ObjectiveGetProgressEvent>(OnGetMostIdentitiesProgress);
    }
    // DS14-end
