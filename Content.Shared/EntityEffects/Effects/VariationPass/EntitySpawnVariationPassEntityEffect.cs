...
public sealed class EntitySpawnVariationPassEntityEffectSystem : EntityEffectSystem<MapGridComponent, EntitySpawnVariationPass> // DS14 - pre-v288 engine
{
    // DS14-start - pre-v288 engine
