...
[ByRefEvent]
public record struct EntityConditionEvent<T>(T Condition, EntityUid? SourceEnt) where T : EntityConditionBase<T>
{
    /// <summary>
    ...
    /// <summary>
    /// Optional source entity that requested the condition check.
    /// </summary>
