...
public sealed partial class ClumsyStatusEffectSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<ClumsyCatchStatusEffectComponent, StatusEffectRelayedEvent<CatchAttemptEvent>>(OnCatchAttemptEvent);
        SubscribeLocalEvent<ClumsyDefibStatusEffectComponent, StatusEffectRelayedEvent<SelfBeforeDefibrillatorZapsEvent>>(OnBeforeDefibrillatorZapsEvent);
        SubscribeLocalEvent<ClumsyGunStatusEffectComponent, StatusEffectRelayedEvent<SelfBeforeGunShotEvent>>(OnBeforeGunShotEvent);
        SubscribeLocalEvent<ClumsyInjectorStatusEffectComponent, StatusEffectRelayedEvent<SelfBeforeInjectEvent>>(OnBeforeInjectEvent);
        SubscribeLocalEvent<ClumsyVaultStatusEffectComponent, StatusEffectRelayedEvent<SelfBeforeClimbEvent>>(OnBeforeClimbEvent);
    }
    // DS14-end
