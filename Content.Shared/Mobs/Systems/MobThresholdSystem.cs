...
public sealed partial class MobThresholdSystem : EntitySystem
{
    ...
    {
        threshold = null;
        if (!Resolve(target, ref thresholdComponent, false)) //DS14
            return false;
    ...
    // DS14-start
    public void SetCurrentThresholdState(EntityUid uid,
        MobState state,
        MobThresholdsComponent? component = null)
    {
        if (!Resolve(uid, ref component) || component.CurrentThresholdState == state)
            return;
