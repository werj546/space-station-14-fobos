...
public sealed partial class AnchorableSystem : EntitySystem
{
    ...
    [Dependency] private readonly SharedStationSystem _stationSystem = null!;
    ...
    private void OnAnchorOnStation(Entity<AnchorOnlyOnStationComponent> ent, ref AnchorAttemptEvent args)
    {
        ...
        args.FailMessage = ent.Comp.PopupMessageAnchorFail; // DS14 - keep the localization key consistent for both anchor paths.
        args.Cancel();
    }
        ...
        ToolComponent? usingTool = null)
    {
        ...
        {
            if (failMessage != null)
                _popup.PopupClient(Loc.GetString(failMessage), uid, userUid); // DS14 - FailMessage stores a localization key.
            return;
        }
