...
{
    // DS14-start: old engine IoC requires readonly dependency fields.
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<ShearableComponent, SolutionContainerChangedEvent>(OnSolutionChange); // DS14 - old solution container event API.
    }
    ...
    /// <param name="ent">the entity containing a shearable component that will be checked.</param>
    /// <param name="args">Arguments passed through by the ExaminedEvent.</param>
    private void OnSolutionChange(Entity<ShearableComponent> ent, ref SolutionContainerChangedEvent args) // DS14 - old solution container event API.
    {
        ...
        if (args.SolutionId != ent.Comp.TargetSolutionName) // DS14 - old solution container event API.
            return;

        UpdateShearingLayer(ent, args.Solution); // DS14 - old solution container event API.
    }
}
